...
<body>
<h1 class="heading">Student page</h1>

<div>
    <form method="post">
    	<input type="button" value="Attendence" name="Attendence" onClick="submitForm(this)">
        <input type="button" value="Marks" name="Marks" onClick="submitForm(this)">
    </form>
    </div>
</body>
</html>