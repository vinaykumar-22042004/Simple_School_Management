...
<body>
<h1 class="heading">Teacher Page</h1>

<div>
    <form method="post">
    	<input type="button" value="Attendence" name="Attendenceupdate" onClick="submitForm(this)">
        <input type="button" value="Marks" name="Marksupdate" onClick="submitForm(this)">
    </form>
    </div>
</body>
</html>